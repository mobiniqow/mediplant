...
from .views import CreateBasket, AddProductToBasket, UpdateProductUnit, RemoveProductFromBasket, Checkout, \
...
urlpatterns = [
    ...
    path('basket/<int:basket_id>/product/<int:product_id>/update/', UpdateProductUnit.as_view(),
         name='update_product_unit'),
    path('basket/<int:basket_id>/product/<int:product_id>/remove/', RemoveProductFromBasket.as_view(),
         name='remove_product'),
