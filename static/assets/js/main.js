(function($) {
    ...
    $('.wishlist').on("click", function() {
        $('.ms-wish-notify').fadeIn().append('<p class="wish-note">افزودن محصول به <a href="wishlist.html"> علاقه مندی ها</a> موفقیت آمیز بوده است!</p>');
        setTimeout(function() {
            $('.wish-note').fadeOut()
        }, 1000);
    });
    ...
    $('.compare').on("click", function() {
        $('.ms-compare-notify').fadeIn().append('<p class="compare-note">افزودن محصول به <a href="compare.html"> لیست مقایسه</a> موفقیت آمیز بوده است!</p>');
        setTimeout(function() {
    ...
    $(".ms-tools-sidebar-toggle").on("click", function(e) {
        ...
        if ($(this).hasClass("open-features")) {
            $(".ms-features-sidebar").stop().animate({ left: "0px" }, 100);
            $(".ms-features-sidebar-overlay").fadeIn();
            if ($(".ms-tools-sidebar-toggle").not("open-features")) {
                $(".ms-features-sidebar").stop().animate({ left: "-250px" }, 100);
                $(".ms-tools-sidebar-toggle").addClass("open-features");
            }
            if ($(".ms-tools-sidebar-toggle").not("open-features")) {
                $(".ms-features-sidebar").stop().animate({ left: "0" }, 100);
                $(".ms-tools-sidebar-toggle").addClass("open-features");
                $(".ms-features-sidebar-overlay").fadeIn();
            }
        } else {
