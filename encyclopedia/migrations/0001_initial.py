    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='encyclopedia.articleencyclopediacategory', verbose_name='دسته بندی')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hashtags', models.ManyToManyField(related_name='news', to='encyclopedia.hashtag', verbose_name='هشتگ\u200cها')),
            ],
            options={
                'verbose_name': 'خبر',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('active', 'فعال'), ('inactive', 'غیرفعال'), ('recomment', 'پاسخ')], default='active', max_length=10, verbose_name='وضعیت')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ارسال')),
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recomments', to='encyclopedia.comment', verbose_name='پاسخ به')),
                ('news', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='encyclopedia.news', verbose_name='خبر')),
            ],
            options={
                'verbose_name': 'نظر',
